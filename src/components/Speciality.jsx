...
const Speciality = () => {
  return (
    <div className='flex flex-col items-center gap-4  py-16 text-gray-800 ' id='speciality'>
      <h1 className='text-3xl font-medium'>Find Your Specialist According to your needs.</h1>
        <p className='sm:w-1/3 text-center text-sm'>Browse Through Our list of Doctors Schdeule your appointment now.</p>
